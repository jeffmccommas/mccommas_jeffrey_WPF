...
if (!isNaN(milesDriven)) {
    alert("This is a valid number "); // Check that the user has entered a valid number, if is not a number, alert user
} else {
    alert("this is not a number. Please enter a valid number ");
}
...
console.log("Congradulations!! Your gas mileage is " + gasMileage + "");
